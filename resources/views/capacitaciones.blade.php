    ...
    <div class="sgc">
        <div class="card_sgc">
            <button class="user-card">
                ...
                <a href="https://telmex.com/">Asesores de Venta</a>
            </button>  
        </div>
        <div class="card_sgc">
            <button class="user-card">
                ...
                <a href="https://telmex.com/">General</a>
            </button> 
        </div>
        <div class="card_sgc">
            <button class="user-card">
                ...
                <a href="https://telmex.com/">Intendentes</a>
            </button>
        </div>
        <div class="card_sgc">
            <button class="user-card">
                ...
                <a href="https://telmex.com/">Residentes</a>
            </button>
        </div>
        <div class="card_sgc">
            <button class="user-card">
                ...
                <a href="https://telmex.com/">Almacenista</a>
            </button>
        </div>
        <div class="card_sgc">
            <button class="user-card">
                ...
                <a href="https://telmex.com/">Administrativos</a>
            </button>
        </div>
        <div class="card_sgc">
            <button class="user-card">
                ...
                <a href="https://telmex.com/">Coordinadores</a>
            </button>
        </div>  
    </div>
    </x-app-layout>